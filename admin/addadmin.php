				...
				<div style="background-color: honeydew; width: auto; height: 567px; overflow-y: scroll;" class="col-9">
					<div style="border: 1px solid #e5ede8; margin: 10px 0; padding: 0 12px;">
						<div class="row outerdiv" style="margin-top: 12px;">
                            <div class="col-12">
                                <i class="fas fa-toolbox"></i><span><a href="#"> Add Admin</a></span>
                            </div>
                        </div>                       
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-10">
                                          <input type="number" name="user_id" class="form-control binput" value="<?php print $fetch[0]?>">
                                        </div>
                                      </div>
									  <div class="row mb-3">
                                        <label class="col-2 col-form-label">Username</label>
                                        <div class="col-10">
                                          <input type="text" name="username" class="form-control binput" value="<?php print $fetch[1]?>">
                                        </div>
                                      </div>
                                    <div class="row mb-3">
                                        <label class="col-2 col-form-label">Email</label>
                                        <div class="col-10">
                                          <input type="email" name="user_email" class="form-control" value="<?php print $fetch[2]?>">
                                        </div>
                                    </div>
									<div class="row mb-3">
                                        <label class="col-2 col-form-label">Phone</label>
                                        <div class="col-10">
                                          <input type="text" name="user_phone" class="form-control" value="<?php print $fetch[3]?>">
                                        </div>
                                    </div>
									<div class="row mb-3">
                                        <label class="col-2 col-form-label">Password</label>
                                        <div class="col-10">
                                          <input type="text" name="user_password" class="form-control" value="<?php print $fetch[4]?>">
                                        </div>
                                    </div>
									<div class="row mb-3">
                                        <label class="col-2 col-form-label">Re-enter Password</label>
                                        <div class="col-10">
                                          <input type="text" name="user_con_password" class="form-control" value="<?php print $fetch[5]?>">
                                        </div>
                                    </div>
									<div class="row mb-3">
                                        ...
                                        <?php
                                                ...
                                                {?>
                                                    <tr>
                                                            ...
                                                            <td>
                                                                <a href="addadmin.php?edit=<?php echo $fetch[0];?>" class="btn btn-info">Edit</a>
                                                                <a href="addadmin.php?del=<?php echo $fetch[0];?>" class="btn btn-danger">Delete</a>
                                                            </td>
                                                    </tr>
                                                    <?php
                                                }
