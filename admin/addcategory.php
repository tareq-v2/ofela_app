				...
				<div style="background-color: honeydew; width: auto; height: 560px; overflow-y: scroll;" class="col-9">
					<div style="margin: 10px 10px;">
                        <div class="row outerdiv" style="margin-top: 12px;">
                            <div class="col-12">
                                <i class="fas fa-toolbox"></i><span><a href="#"> Add Category</a></span>
                            </div>
                        </div>                       
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-10">
                                          <input type="number" class="form-control" name="cat_id" value="<?php print $fetch_item[0]?>">
                                        </div>
                                      </div>
                                      <div class="row mb-3">
                                        <label class="col-2 col-form-label">Category Name</label>
                                        <div class="col-10">
                                          <input type="text" class="form-control" name="cat_name" value="<?php print $fetch_item[1]?>">
                                        </div>
                                    </div>
									<div class="row mb-3">
                                        ...
                                        <?php
                                                ...
                                                {?>
                                                    <tr>
                                                            ...
                                                            <td><img src="img2/<?php echo $fetch[0];?>.jpg" height="100" width="100"></td>
