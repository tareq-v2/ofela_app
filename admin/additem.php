				...
				<div style="background-color: honeydew; width: auto; height: 560px; overflow-y: scroll;" class="col-9">
					<div style="margin: 10px 10px; padding: 0 10px;">
                        <div class="row outerdiv" style="margin-top: 12px;">
                            <div class="col-12">
                                <i class="fas fa-toolbox"></i><span><a href="#"> Add Item</a></span>
                            </div>
                        </div>                       
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                    <div class="row mb-3">
                                        <label class="col-2 col-form-label">Item ID</label>
                                        <div class="col-10">
                                          <input type="number" class="form-control binput" name="item_id" value="<?php print $fetch[0]?>">
                                        </div>
                                      </div>
                                    <div class="row mb-3">
                                        ...
                                        <?php
                                                ...
                                                {?>
                                                    <tr>
                                                            ...
                                                            <td>
                                                                <a href="additem.php?edit=<?php echo $fetch[0];?>" class="btn btn-info">Edit</a>
                                                                <a href="additem.php?del=<?php echo $fetch[0];?>" class="btn btn-danger">Delete</a>
                                                            </td>
                                                    </tr>
                                                    <?php
                                                }
