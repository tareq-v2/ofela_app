				...
				<div style="background-color: honeydew; width: auto; height: 560px; overflow-y: scroll;" class="col-9">
					<div style=" margin: 10px 10px;">
                        <div class="row outerdiv" style="margin-top: 12px;">
                            <div class="col-12">
                                <i class="fas fa-toolbox"></i><span><a href="#"> Add Brand</a></span>
                            </div>
                        </div>                       
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                    <div class="row mb-3">
                                        <label class="col-2 col-form-label">Brand ID</label>
                                        <div class="col-10">
                                          <input type="number" name="brand_id" class="form-control" value="<?php echo $fetch_item[0];?>">
                                        </div>
                                    </div>
									<div class="row mb-3">
                                        <label class="col-2 col-form-label">Brand Name</label>
                                        <div class="col-10">
                                          <input type="text" name="brand_name" class="form-control" value="<?php echo $fetch_item[1];?>">
                                        </div>
                                    </div>
                                      <div class="addbtn">
