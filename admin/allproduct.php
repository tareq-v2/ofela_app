				...
				<div style="background-color: honeydew; width: auto; height: 560px; overflow-y: scroll;" class="col-9">
					<div style="margin: 10px 10px;">
                        <div class="row outerdiv" style="margin-top: 12px;">
                            <div class="col-12">
                                <i class="fas fa-toolbox"></i><span><a href="#"> Add Product</a></span>
                            </div>
                        </div>                       
                        <div class="row">
							<div class="col-12">
                                ...
                                <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
										...
										<div class="row mb-3">
											...
											<div class="col-10">
											  <input type="text" class="form-control" name="p_name" value="<?php print $fetch[5]?>">
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-2 col-form-label">Sale price</label>
											<div class="col-10">
											  <input type="text" class="form-control" name="sale_price" value="<?php print $fetch[7]?>">
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-2 col-form-label">Mesurement</label>
											<div class="col-10">
											  <input type="text" class="form-control" name="mesurement" value="<?php print $fetch[8]?>">
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-2 col-form-label">Description</label>
											<div class="col-10">
											<input type="text" class="form-control" name="description" value="<?php print $fetch[6]?>">
											</div>
										</div>
										<div class="row mb-3">
	                                        ...
	                                        <?php
	                                                ...
	                                                {?>
	                                                    <tr>
	                                                            ...
	                                                            <td><img src="productpic/<?php echo $fetch[0];?>.jpg" height="50" width="50"></td>
	                                                            <td>
	                                                                <a href="allproduct.php?edit=<?php echo $fetch[0];?>" class="btn btn-info">Edit</a>
	                                                                <a href="allproduct.php?del=<?php echo $fetch[0];?>" class="btn btn-danger">Delete</a>
	                                                            </td>
	                                                    </tr>
	                                                    <?php
	                                                }
